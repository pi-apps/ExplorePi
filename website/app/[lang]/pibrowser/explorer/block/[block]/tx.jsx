...
export default function Transaction({block,transcript}){
                ...
                <tbody>
                    {
                        data.map((record,index)=>{
                            ...
                            <tr key={index} className='border-b border-slate-300 text-lg'>
                                <td className="py-2">
                                    <Link href={`/${lang}/pibrowser/explorer/tx/${record.hash}`}>
                                ...
                                <td className="py-2">
                                    <Link href={`/${lang}/pibrowser/explorer/account/${record.source_account}`}>
